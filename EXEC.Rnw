...
<<MapData, echo=FALSE, warning=FALSE, message=FALSE>>=
map_counties=read.csv("https://github.com/lrsulli/Project/raw/master/map_counties.csv")
@

<<Mapping, echo=FALSE, warning=FALSE, message=FALSE, fig=true, width=6, height=4>>=
