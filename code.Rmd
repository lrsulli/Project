...
dataURL <- "https://github.com/lrsulli/Project/raw/master/Data/fp_survey_2_15_13.xlsx"
...
temp = tempfile(fileext = '.xlsx')
dataURL <- "https://github.com/lrsulli/Project/raw/master/Data/recode_Q12_Q22toQ25.xlsx"
download.file(dataURL, destfile = temp, mode = 'wb')
...
temp = tempfile(fileext = '.xlsx')
dataURL <- "https://github.com/lrsulli/Project/raw/master/Data/address_list_5_20_13.xlsx"
download.file(dataURL, destfile = temp, mode = 'wb')
...
```{r Merge Data: Census}
# Merge Census1 and Census2
data_census = merge(data_census1, data_census2, by="tr10fips", all=T) #keep all tracts

# Merge Census3 with Census1 and Census2
data_census = merge(data_census, data_census3, by="tr10fips", all=T)
...
data = merge(data, data_census, by='STUDYID') #keep tracts with orgs
...
data_census$povpop10071[is.na(data_census$povpop10071)] <- 0

data_census <- mutate(data_census, pov_rateT = ifelse(povpop10071==0, povpop100711mile / povpopd711mile, povpop10071 / povpopd71))
...
# Create fips number without state identifier
